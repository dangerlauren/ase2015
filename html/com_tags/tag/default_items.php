...
$db = JFactory::getDbo();
$db->setQuery("SELECT cat.title FROM #__categories cat WHERE cat.id=$item->core_catid");
$parent_category_title = $db->loadResult();
		...
		?>
			...
			<?php else: ?>
				...
				<?php if($parent_category_title != 'ROOT'){
 echo '<p class="tagcat">'.$parent_category_title.'</p>';
} ?>
			<?php endif; ?>
